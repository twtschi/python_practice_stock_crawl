...
#Generate Plot Source
    ...
    p.add_tools(hover)
    p.circle(temp_x,temp_high,color="red" ,size=5,source=source_high)
    p.circle(temp_x,temp_low,color="green",size=5,source=source_low)
    ...
    p.circle(buy_sig_x,buy_sig_y,source=source_buy_signal,size=10,color="red")
    p.circle(sold_sig_x,sold_sig_y,source=source_sold_signal,size=10,color="green")
    show(p)